  ...
  return (
    <section className="relative py-20 overflow-hidden" dir="rtl" id="faq">
      ...
      <div className="absolute inset-0 overflow-hidden">
        <div className="absolute -top-[30%] right-[10%] w-[700px] h-[700px] bg-gradient-to-br from-primary-500/20 via-red-500/5 to-transparent rounded-full blur-3xl transform rotate-45" />
        <div className="absolute -bottom-[30%] left-[10%] w-[700px] h-[700px] bg-gradient-to-tl from-red-500/20 via-primary-500/5 to-transparent rounded-full blur-3xl transform -rotate-45" />
      </div>
