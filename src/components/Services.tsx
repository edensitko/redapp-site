...
// ייבוא של 4 אייקונים שונים (או כמה שיש לך)
import { LottieIcon, LottieIcon2, LottieIcon3, LottieIcon4 } from './LottieIcon';
...
const Services: React.FC = () => {
  const services = [
    ...
    },
    {
      ...
      icon: <LottieIcon2 />, // אייקון לוטי 2
    },
    {
      title: 'אבטחת מידע',
      ...
      icon: <LottieIcon3 />, // אייקון לוטי 3
    },
    {
      ...
      icon: <LottieIcon4 />, // אייקון לוטי 4
    },
    {
      title: 'UI/UX עיצוב',
      ...
      // אפשר לשים כאן שוב אייקון קיים או חדש
      icon: <LottieIcon />,
    },
    {
      title: 'תחזוקה ותמיכה',
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-white dark:bg-[rgb(36,37,37)] rounded-2xl p-8 shadow-lg border border-gray-100 dark:border-[rgb(46,47,47)]"
            >
              ...
              <div className="relative p-6">
                ...
                >
                  <motion.div
                    ...
                    className="w-12 h-12"
                  >
                    {/* כאן נכנס האייקון הייחודי של כל שירות */}
                    {service.icon}
                  </motion.div>
                </div>
